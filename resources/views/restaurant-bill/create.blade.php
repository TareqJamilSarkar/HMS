...
@section('title', 'Add Restaurant Bill')
@section('content')
    <div class="fade-in">
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 text-gradient mb-1">Add Restaurant Bill</h1>
                        <p class="text-muted mb-0">Create a new restaurant bill for a guest</p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-lh">
                    ...
                    <div class="card-body">
                        <form action="{{ route('restaurant-bill.store') }}" method="POST">
                            @csrf

                            <!-- Guest Selection -->
                            <div class="mb-3">
                                <label for="transaction_id" class="form-label fw-medium">
                                    Select Guest <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-check me-2"></i>Add Bill
                                </button>
                                <a href="{{ route('restaurant-bill.index') }}" class="btn btn-outline-secondary">
                ...
                <div class="card card-lh bg-light">
                    <div class="card-body">
                        <h6 class="fw-bold mb-3">
                            <i class="fas fa-circle-info text-info me-2"></i>Tips
                        </h6>
                        <ul class="list-unstyled text-small">
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                All customers available - checked in & past bookings
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                Status shown for each guest (checked in or not)
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                Add multiple items per guest
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                            ...
                            <li class="mb-2">
                                <i class="fas fa-check text-success me-2"></i>
                                Bills can be edited or marked as completed later
                            </li>
                        </ul>
                    </div>
                </div>
